...
if($packages->have_posts()) :
	...
	$interval_text_arr = array(
		'day' => array( __( 'Day', 'noo'), __( 'Days', 'noo') ),
		'week' => array( __( 'Week', 'noo'), __( 'Weeks', 'noo') ),
		'month' => array( __( 'Month', 'noo'), __( 'Months', 'noo') ),
		'year' => array( __( 'Year', 'noo'), __( 'Years', 'noo') ),
	);
	...
	while ($packages->have_posts()): $packages->the_post();
		...
		$interval_unit = noo_get_post_meta(null,'_noo_membership_interval_unit');
		$interval_unit_text = isset( $interval_text_arr[$interval_unit] ) ? $interval_text_arr[$interval_unit] : $inarray( '', '' );
		$after_price = '';
		...
		$price = ( trim($after_price)  != '' ) ? $price . ' / ' . $after_price : $price;
