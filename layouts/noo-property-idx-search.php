 ...
 * Get price global
 */
$global_info = dsSearchAgent_ApiRequest::FetchData( 'MlsCapabilities' );
$global_info = json_decode( $global_info[ 'body' ], true );
$min_price = ! empty( $global_info[ 'MinPrice' ] ) ? absint( $global_info[ 'MinPrice' ] ) : 0;
$max_price = ! empty( $global_info[ 'MaxPrice' ] ) ? absint( $global_info[ 'MaxPrice' ] ) : 100000000;
		   			...
		   			<div class="gsearch-content idxs">
		   				<div class="gsearch-field">
							...
							<div class="form-group gprice">
					   			...
					   			<input type="hidden" name="idx-q-PriceMin" id="idx-q-PriceMin" class="gprice_min" data-min="0" placeholder="Any" value="<?php echo $min_price;?>" />
					   			<input type="hidden" name="idx-q-PriceMax" id="idx-q-PriceMax" class="gprice_max" data-max="<?php echo $max_price;?>" placeholder="Any" value="<?php echo $max_price;?>" />
					   		</div>
