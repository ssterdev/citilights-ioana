                    ...
                    <div class="masonry-filters">
                        <ul data-option-key="filter">
                            ...
                            foreach ($category_arr as $cat):
                                ...
                                <li>
                                    <a href="#"
                                       data-option-value=".<?php echo 'mansonry-filter-' . $category->slug ?>"><?php echo $category->name; ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                            ...
                            <?php if ($post_format == 'quote'): ?>
                                ...
                                <h2 class="content-title content-quote">
                                    <a href="<?php the_permalink(); ?>"
                                       title="<?php echo esc_attr(sprintf(__('Permanent link to: "%s"', 'noo'), the_title_attribute('echo=0'))); ?>">
                                        <?php echo $quote; ?>
                                    </a>
                                </h2>
                                <cite class="content-sub-title content-cite"><i
                                            class="fa fa-quote-left"></i> <?php echo $cite; ?></cite>
                            <?php else: ?>
                                ...
                                <?php if ($post_format == 'link'): ?>
                                    ...
                                    <?php if ($link != '') : ?>
										...
										<a href="<?php echo $link; ?>"
                                           title="<?php echo esc_attr(sprintf(__('Shared link from post: "%s"', 'noo'), the_title_attribute('echo=0'))); ?>"
                                           target="_blank">
...
//        $html[] = '<H1>YOU CANT UNSEE THIS</H1>';
        $html[] = do_shortcode($content);
        $html[] = '  </ul>';
                        ...
                        <div id="jp_interface_<?php echo $id; ?>" class="jp-interface">
                            ...
                            <ul class="jp-controls">
                                <li><a href="#" class="jp-play"
                                       tabindex="1"><span><?php echo __('Play', 'noo') ?></span></a></li>
                                <li><a href="#" class="jp-pause"
                                       tabindex="1"><span><?php echo __('Pause', 'noo') ?></span></a></li>
                                <li><a href="#" class="jp-mute"
                                       tabindex="1"><span><?php echo __('Mute', 'noo') ?></span></a></li>
                                <li><a href="#" class="jp-unmute"
                                       tabindex="1"><span><?php echo __('UnMute', 'noo') ?></span></a></li>
                            </ul>
                ...
                <div class="jp-controls-container jp-audio">
                    <div id="jp_interface_<?php echo $id; ?>" class="jp-interface">
                        <ul class="jp-controls">
                            <li><a href="#" class="jp-play"
                                   tabindex="1"><span><?php echo __('Play', 'noo') ?></span></a></li>
                            <li><a href="#" class="jp-pause" tabindex="1"><span><?php echo __('Pause', 'noo') ?></span></a>
                            </li>
                            <li><a href="#" class="jp-mute"
                                   tabindex="1"><span><?php echo __('Mute', 'noo') ?></span></a></li>
                            <li><a href="#" class="jp-unmute"
...
if (!function_exists('noo_shortcode_testimonial')) {
    ...
    {
        $title = $autoplay = $duration = $data_source = $testimonial_ids = $category = $custom_style = $class = $visibility = '';
        extract(shortcode_atts(array(
            'title' => '',
            'autoplay' => 'true',
            'duration' => '4000',
        ...
        $class = ($class != '') ? ' class="' . esc_attr($class) . '"' : '';
        $custom_style = ($custom_style != '') ? ' style="' . $custom_style . '"' : '';
        $data_source = esc_attr($data_source);
        $testimonial_ids = esc_attr($testimonial_ids);
        ...
        ob_start();
        include(locate_template("./layouts/shortcode-testimonial.php"));
...
if (!function_exists('noo_shortcode_client')) {
    ...
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_client', $atts);
        endif;
        $clients = $visibility = $class = $custom_style = $autoplay = $slide_duration = $logo_per_slide = $layout_type = $el_class = $noo_animation = $css_animation = $duration = $delay = '';
        extract(shortcode_atts(array(
            'clients' => '',
            'logo_per_slide' => '5',
            'style' => '',
        ...
        ?>
        <div id="client_<?php echo $uniqueID; ?>" <?php echo($class . ' ' . $custom_style); ?>>
            <div class="client-row owl-carousel owl-theme">
                <?php foreach ($clients as $client) : ?>
                    <div class="client-item" data-page=''>
                        <?php if (count($client) == 3) : // Show if have url in $client array                     ?>
                        <a href="<?php echo esc_url($client['url']); ?>" target="_blank">
                            <?php endif; ?>
                            <?php if (isset($client['logo'])) : ?>
                                <?php $image_src = wp_get_attachment_url($client['logo']); ?>
                                <img src="<?php echo esc_url($image_src); ?>" alt="<?php if(!empty($client['name'])) { echo $client['name']; } ?>">
                            <?php else : echo esc_html__('Please select logo!', 'noo'); ?>
                            <?php endif; ?>
                            <?php if (count($client) == 3) : // Show if have url in $client array                     ?>
                        </a>
                    <?php endif; ?>
        ...
        <script type="text/javascript">
            jQuery('document').ready(function ($) {
                $("#client_<?php echo $uniqueID;?> .client-row").owlCarousel({
                    items: <?php echo esc_js($logo_per_slide)?>,
                    loop: true,
                    margin: 20,
    ...
    ;
    add_shortcode('noo_client', 'noo_shortcode_client');
};
// Noo box content
//============================


if (!function_exists('noo_shortcode_box_contents')) {
    function noo_shortcode_box_contents($atts)
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_box_contents', $atts);
        endif;
        $content = $custom_style = $style = $visibility = $text_color = '';
        extract(shortcode_atts(array(
            'contents' => '',
            'style' => '',
            'visibility' => '',
        ...
        $contents = (array)vc_param_group_parse_atts($contents);
        $clients_id = uniqid();
        $rtl = '';
        if (is_rtl()) {
            $rtl = 'true';
            ...
            <div>
                <div class="noo-vc-col text-center col-md-12 ">
                    <div class="container-boxed max">
                        <div class="noo-vc-row row box-content-row">
                            <?php foreach ($contents as $content) :
                                ?>
                                <div class="noo-vc-col our-service box-content-item">
                                <span id="noo-icon-2" class="noo-icon service-icon icon-circle icon-style-custom">
                                    <a href="<?php echo esc_url($content['url']); ?>">
                                        <i class="<?php echo esc_attr($content['icon']); ?>"></i>
                                    </a>
                                </span>
                                    <hr style="border-top: 1px solid rgba(0,0,0,0); margin: 20px 0">
                                    <div class="noo-text-block" style="color: #fff">
                                        <h5 style="color: <?php echo esc_html($text_color) ?>"><?php echo $content['title'] ?> </h5>
                                        <p style="text-align: center; color: <?php echo esc_html($text_color) ?>"><?php if (isset($content['description'])) {
                                                echo $content['description'];
                                            } ?> </p>

                                        <p class="" style="text-align: center">
                                            <a href="<?php echo esc_url($content['url']); ?>">
                                                <?php if (isset($content['url_mask'])) {
                                                    echo esc_attr($content['url_mask']);
                                                } ?>
    ...
    ;
    add_shortcode('noo_box_contents', 'noo_shortcode_box_contents');
}
// Noo gallery
//============================

if (!function_exists('noo_gallery')) {
    function noo_shortcode_gallery($atts)
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_gallery', $atts);
        endif;
        $visibility = $class = $custom_style = $items = $layout = '';
        extract(shortcode_atts(array(
            'items' => '',
            'layout' => 'layout-1',
            'class' => '',
        ...
        $custom_style = ($custom_style != '') ? ' style="' . $custom_style . '"' : '';
        ob_start();
        include(locate_template("./layouts/shortcode-gallery.php"));
        ?>
...
//============================
if (!function_exists('noo_city_info')) {
    function noo_shortcode_city_info($atts)
    {
        extract(shortcode_atts(array(
            'style' => 'masonry',
            'columns' => '3',
        ...
        include(locate_template("./layouts/shortcode-city-information.php"));
    }

    add_shortcode('noo_city_info', 'noo_shortcode_city_info');
}
if (!function_exists('noo_shortcode_call_to_action')) {
    function noo_shortcode_call_to_action($atts)
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_call_to_action', $atts);
        endif;
        $title = $description = $btn_txt = $btn_txt_2 = $btn_url = $btn_url_2 = $visibility = $class = $text_color = $custom_style = $style = '';
        extract(shortcode_atts(array(
            'title' => '',
            'description' => '',
            'btn_txt' => '',
        ...
        ?>
        <div <?php echo($class . ' ' . $custom_style); ?> id="banner_<?php echo esc_html($uniqID); ?>">
            <?php if ($style === 'style-1'): ?>
                <div class="noo-vc-col col-md-12 noo-banner">
                    <div class="noo-vc-row row noo-call-to-action">
                        <div class="noo-vc-col col-md-6 col-md-12 col-sm-6">
                            <div class="noo-text-block">
                                <h3 style="color: <?php echo esc_html($text_color) ?>"><?php echo esc_html($title) ?></h3>
                                <p style="color: <?php echo esc_html($text_color) ?>"><?php echo esc_html($description) ?></p>
                            </div>
                        </div>
                        <div class="noo-vc-col col-md-6 col-md-12 col-sm-6 banner-r">
                            <a href="<?php echo $btn_url; ?>" id="noo-button-2" class="btn btn-thirdary rounded metro btn-default"
                               role="button" target="_blank"><?php echo esc_html($btn_txt) ?></a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            <?php if ($style === 'style-2'): ?>
                <div>
                    <div class="noo-call-to-action-2">
                        <div>
                            <h1><?php echo esc_html($title) ?></h1>
                        </div>
                        <div class="nav-button">
                            <div>
                                <a href="<?php echo $btn_url; ?>" target="_blank"
                                        class="btn-1"><?php echo $btn_txt ?></a>
                            </div>
                            <div>
                                <a href="<?php echo $btn_url_2; ?>" target="_blank"
                                        class="btn-2"><?php echo $btn_txt_2 ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ;
    add_shortcode('noo_call_to_action', 'noo_shortcode_call_to_action');
}


if (!function_exists('noo_shortcode_post_slider')) {
    function noo_shortcode_post_slider($atts)
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_post_slider', $atts);
        endif;
        //$visibility = $class = $custom_style = $autoplay = $post_per_page = $category = '';
        extract(shortcode_atts(array(
            'autoplay' => 'true',
            'duration' => '4000',
            'data_source' => '',
        ...
        wp_enqueue_style('owlcarousel2-theme');
        ob_start();
        include(locate_template('./layouts/shortcode-post-slider.php'));
    }

    add_shortcode('noo_post_slider', 'noo_shortcode_post_slider');
}

if (!function_exists('noo_shortcode_video_slider')) {
    function noo_shortcode_video_slider($atts)
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_video_slider', $atts);
        endif;
        $visibility = $class = $custom_style = $autoplay = $items = '';
        extract(shortcode_atts(array(
            'autoplay' => 'true',
            'duration' => '4000',
            'data_source' => '',
        ...
        ob_start();
        include(locate_template('./layouts/shortcode-video-slider.php'));
...
if (!function_exists('noo_shortcode_property_slider_v2')) {
    function noo_shortcode_property_slider_v2($atts)
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_property_slide_v2', $atts);
        endif;
        $visibility = $class = $custom_style = $autoplay = $items = '';
        extract(shortcode_atts(array(
            'slider_time' => '4000',
        ...
        $items = (array)vc_param_group_parse_atts($items);
        ob_start();
        include(locate_template('./layouts/shortcode-property-slider-style-2.php'));
    }

    add_shortcode('noo_property_slide_v2', 'noo_shortcode_property_slider_v2');
}


if (!function_exists('noo_shortcode_property_search')) {
    function noo_shortcode_property_search($atts)
    {
        if ( is_plugin_active('js_composer/include/helpers/helpers_api.php')) :
        $atts = vc_map_get_attributes('noo_property_search', $atts);
        endif;
        $visibility = $class = $custom_style = $autoplay = $items = '';
        extract(shortcode_atts(array(
            'visibility' => '',
        ...
        $items = (array)vc_param_group_parse_atts($items);
        ob_start();
        include(locate_template('./layouts/shortcode-property-search.php'));
        
    }

    add_shortcode('noo_property_search', 'noo_shortcode_property_search');
}

if ( ! class_exists('Noo_Framework_Shortcode_Counter') ) {
    class Noo_Framework_Shortcode_Counter {
        function __construct() {
            add_shortcode('noo_counter', array($this, 'noo_counter_shortcode' ));
        }
        function noo_counter_shortcode($atts) {
            $layout_type = $title = $number = $el_class =
            $noo_animation = $css_animation = $duration = $delay = $styles_animation = '';
            extract(shortcode_atts(array(
                'title'         => '',
                'start_number'  => 0,
                'end_number'    => 3666,
            ...
            ob_start();
            include(locate_template('./layouts/shortcode-counter.php'));
            $content =  ob_get_clean();
            return $content;
        }
    }

    new Noo_Framework_Shortcode_Counter();
}