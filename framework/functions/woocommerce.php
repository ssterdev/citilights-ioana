...
if ( class_exists( 'woocommerce' ) ) {
	...
	// 
	// add_filter( 'single_product_small_thumbnail_size', 'woocommerce_product_small_thumbnail_size' );
	function woocommerce_product_small_thumbnail_size( $thumbnail_size ) {
		if( $thumbnail_size == 'shop_thumbnail' ) {
