...
jQuery( document ).ready( function ( $ ) {
	...
	$( '.form-control-chosen' ).each( function() {
		if ( chosen_browser_is_supported() ) {
			...
			$(this).chosen( {
				...
				no_result_text: noo_chosen.no_result_text,
	...
	if($('.s-prop-location').length && $('.s-prop-sub_location').length) {
		$('.s-prop-location').find('select').change( function(e){
			e.stopPropagation();
		    var val = $(this).val();
		    $('.s-prop-sub_location').find('option').each( function( index ) {
		    	var parent = $(this).data('parent-location');
		    	if( val !== "" && typeof(parent) !== "undefined" && parent != val ) {
		    		$(this).prop( "disabled", true );
		    	} else {
		    		$(this).prop( "disabled", false );
		    	}
		    });
		    var selected = $('.s-prop-sub_location').find('option:selected').each( function() {
		    	var parent = $(this).data('parent-location');
		    	if( val !== "" && typeof(parent) !== "undefined" && parent != val ) {
		    		$(this).prop( "selected", false );
		    	}
		    });
		    $('.s-prop-sub_location').find('select.form-control-chosen').trigger('chosen:updated');
		}).change();
	}
});