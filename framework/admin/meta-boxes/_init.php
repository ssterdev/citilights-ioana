...
if( NOO_SUPPORT_TRAINER ) {
   require_once( NOO_META_BOXES . '/testimonial-meta-box.php' );
}
...
if ( ! function_exists( 'noo_enqueue_meta_boxes_js' ) ) :
	function noo_enqueue_meta_boxes_js( $hook ) {
		...
		wp_register_script( 'noo-meta-boxes-js', NOO_FRAMEWORK_ADMIN_URI . '/assets/js/noo-meta-boxes.js', array( 'jquery', 'media-upload', 'thickbox', 'jquery-ui-sortable' ), NULL, true );
