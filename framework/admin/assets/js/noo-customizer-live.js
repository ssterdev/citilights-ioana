...
( function( $ ) {
	...
	// Agent Columns
	wp.customize( 'noo_agent_columns', function( value ) {
		value.bind( function( newval ) {
			if( nooL10n.is_agents === "true" ) {
				noo_refresh_preview( );
			} else {
	...
	// Agent Grid Style
	wp.customize( 'noo_agent_grid_style', function( value ) {
		value.bind( function( newval ) {
			if( nooL10n.is_agents === "true" ) {
				noo_refresh_preview( );
			} else {
	...
	// Display Style
	wp.customize( 'noo_property_display_style', function( value ) {
		value.bind( function( newval ) {
			if( nooL10n.is_properties === "true" ) {
				noo_refresh_preview( );
			} else {
	...
	// Enable Social Sharing
	wp.customize( 'noo_property_print_button', function( value ) {
		value.bind( function( newval ) {
			if( nooL10n.is_property === "true" ) {
				noo_refresh_preview();
			} else {
