...
(function() {
  ...
  tinymce.create('tinymce.plugins.nooShortcode', {

    init : function(ed, url){
      tinymce.plugins.nooShortcode.theurl = noo_shortcodes_data.url;
    },
    ...
    createControl : function(n, cm) {
      ...
      if ( n == 'noo_shortcodes_mce_button' ) {
        var mce   = this;
        var btn = cm.createSplitButton('noo_shortcodes_button', {
          title: 'NOO Shortcode',
          image: tinymce.plugins.nooShortcode.theurl + '/noo20x20.png',
          icons: false,
          // onclick : function() {},
        });
        ...
        btn.onRenderMenu.add(function (c, m) {
          ...
          c = m.addMenu({title: noo_shortcodes_str.base_element});

          mce.render( c, noo_shortcodes_str.row, 'row' );
          mce.render( c, noo_shortcodes_str.column, 'column' );
          mce.render( c, noo_shortcodes_str.wrapper, 'wrapper' );
          mce.render( c, noo_shortcodes_str.separator, 'separator' );
          mce.render( c, noo_shortcodes_str.gap, 'gap' );
          mce.render( c, noo_shortcodes_str.clear, 'clear' );

          //
          // Typography
          //

          c = m.addMenu({title:noo_shortcodes_str.typography});

          mce.render( c, noo_shortcodes_str.textblock, 'textblock' );
          mce.render( c, noo_shortcodes_str.button, 'button' );
          // mce.render( c, noo_shortcodes_str.headline, 'headline' );
          mce.render( c, noo_shortcodes_str.dropcap, 'dropcap' );
          mce.render( c, noo_shortcodes_str.quote, 'quote' );
          mce.render( c, noo_shortcodes_str.icon, 'icon' );
          mce.render( c, noo_shortcodes_str.social_icon, 'social_icon' );
          mce.render( c, noo_shortcodes_str.icon_list, 'icon_list' );
          mce.render( c, noo_shortcodes_str.icon_list_item, 'icon_list_item' );
          mce.render( c, noo_shortcodes_str.label, 'label' );
          mce.render( c, noo_shortcodes_str.code_block, 'code_block' );

          //
          // Content
          //

          c = m.addMenu({title:noo_shortcodes_str.content});

          mce.render( c, noo_shortcodes_str.accordion, 'accordion' );
          mce.render( c, noo_shortcodes_str.tabs, 'tabs' );
          mce.render( c, noo_shortcodes_str.tour_section, 'tour_section' );
          mce.render( c, noo_shortcodes_str.block_grid, 'block_grid' );
          mce.render( c, noo_shortcodes_str.progress_bar, 'progress_bar' );
          mce.render( c, noo_shortcodes_str.pricing_table, 'pricing_table' );
          mce.render( c, noo_shortcodes_str.pricing_table_column, 'pricing_table_column' );
          mce.render( c, noo_shortcodes_str.pie, 'pie' );
          mce.render( c, noo_shortcodes_str.cta_button, 'cta_button' );
          mce.render( c, noo_shortcodes_str.counter, 'counter' );
          mce.render( c, noo_shortcodes_str.message, 'message' );
          ...
          c = m.addMenu({title:noo_shortcodes_str.citilights});

          mce.render( c, noo_shortcodes_str.recent_properties, 'recent_properties' );
          mce.render( c, noo_shortcodes_str.advanced_search_property, 'advanced_search_property' );
          mce.render( c, noo_shortcodes_str.recent_agents, 'recent_agents' );
          mce.render( c, noo_shortcodes_str.membership_packages, 'membership_packages' );
          mce.render( c, noo_shortcodes_str.login_register, 'login_register' );
          mce.render( c, noo_shortcodes_str.property_slider, 'property_slider' );
          mce.render( c, noo_shortcodes_str.property_slide, 'property_slide' );
          mce.render( c, noo_shortcodes_str.single_property, 'single_property' );

          //
          // WP Content
          //

          c = m.addMenu({title:noo_shortcodes_str.wordpress_content});

          mce.render( c, noo_shortcodes_str.widget_area, 'widget_area' );
          mce.render( c, noo_shortcodes_str.blog, 'blog' );
          // mce.render( c, noo_shortcodes_str.author, 'author' );
          mce.render( c, noo_shortcodes_str.team_member, 'team_member' );

          if ( noo_shortcodes_data.contact_form_7 ) {
            mce.render( c, noo_shortcodes_str.contact_form_7, 'contact_form_7' );
          }
          ...
          c = m.addMenu({title:noo_shortcodes_str.media});

          mce.render( c, noo_shortcodes_str.image, 'image' );

          if( noo_shortcodes_data.rev_slider ) {
            mce.render( c, noo_shortcodes_str.rev_slider, 'rev_slider' );
          }

          mce.render( c, noo_shortcodes_str.slider, 'slider' );
          mce.render( c, noo_shortcodes_str.slide, 'slide' );
          mce.render( c, noo_shortcodes_str.lightbox, 'lightbox' );
          mce.render( c, noo_shortcodes_str.video_player, 'video_player' );
          mce.render( c, noo_shortcodes_str.video_embed, 'video_embed' );
          mce.render( c, noo_shortcodes_str.audio_player, 'audio_player' );
          mce.render( c, noo_shortcodes_str.audio_embed, 'audio_embed' );
          mce.render( c, noo_shortcodes_str.google_map, 'google_map' );
          mce.render( c, noo_shortcodes_str.social_share, 'social_share' );

          //
          // Custom
          //

          c = m.addMenu({title:noo_shortcodes_str.custom});

          mce.render( c, noo_shortcodes_str.raw_html, 'raw_html' );
          mce.render( c, noo_shortcodes_str.raw_js, 'raw_js' );
    ...
    render : function(ed, title, id) {
      ...
      ed.add({
        ...
        onclick: function () {
          ...
          var url = tinymce.plugins.nooShortcode.theurl;
          var width = jQuery(window).width(), W = ( 720 < width ) ? 640 : width - 80;
          var H = jQuery(window).height() - 120;
          ...
          if(id === 'animation') {
            ...
            jQuery.get(url + "/noo_shortcodes_animation.php", function(data){
              ...
              jQuery('#TB_window #noo-save-shortcodes').click(function(){
                ...
                shortcode += '] Add any shortcode/content here... [/animation]';
          ...
          if(id == 'advanced_search_property') {
            jQuery("#noo-shortcodes-form-wrapper").remove();
          ...
          if(id === 'property_slider') {
            ...
            jQuery.get(url + "/noo_shortcodes_property_slider.php", function(data){
              ...
              jQuery('#TB_window #noo-save-shortcodes').click(function(){
                ...
                shortcode += '] Input Slide here ... [/property_slider]';
  ...
  tinymce.PluginManager.add('noo_shortcodes', tinymce.plugins.nooShortcode);
