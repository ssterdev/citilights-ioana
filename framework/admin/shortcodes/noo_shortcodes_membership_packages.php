      ...
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="style" id="style">
            <option value="ascending" selected="true"><?php _e('Ascending', 'noo'); ?></option>
            <option value="classic"><?php _e('Classic', 'noo'); ?></option>
          </select>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="featured_item"><?php _e('Featured Item', 'noo'); ?></label>
        <div class="noo-control">
          <input type="text" id="featured_item" name="featured_item" class="noo-slider" value="2" data-min="1" data-max="10"/>
          <small class="noo-control-desc"><?php _e( 'Enter the no. of the Package that is featured', 'noo' ); ?></small>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="btn_text"><?php _e('Buttons Text', 'noo'); ?></label>
        <div class="noo-control">
          <input type="text" name="btn_text" id="btn_text" value="<?php _e('Sign Up', 'noo'); ?>"/>
        </div>
      </div>
      <hr>
      <div class="noo-form-group">
