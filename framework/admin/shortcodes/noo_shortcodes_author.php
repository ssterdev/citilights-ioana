  ...
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">
        <label for="author"><?php _e('Select Author', 'noo'); ?></label>
      ...
      <hr>
      <div class="noo-form-group">
        <label for="custom_avatar"><?php _e('Custom Avatar', 'noo'); ?></label>
        <div class="noo-control">
          <input id="custom_avatar" type="text" name="custom_avatar" class="noo-wpmedia parent-control" value=""/>
          <small class="noo-control-desc"><?php _e('Leave it blank to use Author\'s default Avatar.', 'noo'); ?></small>
      ...
      <div class="noo-form-group">
        <label for="role"><?php _e('Role', 'noo'); ?></label>
        <div class="noo-control">
