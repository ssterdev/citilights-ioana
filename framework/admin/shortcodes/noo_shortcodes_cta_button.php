...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        <label for="message"><?php _e('Message', 'noo'); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          ...
          <label for="fullwidth">
            <input name="fullwidth" id="fullwidth" type="checkbox" /><?php _e('Full-Width', 'noo'); ?>
          </label>
        </div>
      </div>
      <div class="noo-form-group size-custom-child" style="display:none;">
        <label for="vertical_padding"><?php _e('Custom Vertical Padding (px)', 'noo'); ?></label>
        <div class="noo-control">
          <input type="text" id="vertical_padding" name="vertical_padding" class="noo-slider" value="0" data-min="0" data-max="50"/>
        </div>
      </div>
      <div class="noo-form-group size-custom-child" style="display:none;">
        <label for="horizontal_padding"><?php _e('Custom Horizontal Padding (px)', 'noo'); ?></label>
        <div class="noo-control">
          <input type="text" id="horizontal_padding" name="horizontal_padding" class="noo-slider" value="0" data-min="0" data-max="50"/>
        </div>
      </div>
      <hr>
      <div class="noo-form-group">
        <label for="icon"><?php _e('Button Icon', 'noo'); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group skin-custom-child" style="display:none;">
        <label for="hover_text_color"><?php _e('Hover Color', 'noo'); ?></label>
        <div class="noo-control">
