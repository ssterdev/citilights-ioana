...
if ( ! function_exists( 'noo_customizer_register_options_header' ) ) :
	function noo_customizer_register_options_header( $wp_customize ) {
		...
		$helper->add_control(
			...
			'checkbox',
			__( 'Shrink NavBar when Scrolling', 'noo' ),
			1,
			array(),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
			...
			'checkbox',
			__( 'Only Display when Scrolling Up', 'noo' ),
			0,
			array(),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
			...
			'radio',
			__( 'Position of Social Icons', 'noo' ),
			'content_left',
			array(
				'choices' => array(
					'content_right' => __( 'On the left side', 'noo' ),
					'content_left'  => __( 'On the right side', 'noo' ),
				)
			),
			array( 'transport' => 'postMessage' )
		);
...
if ( ! function_exists( 'noo_customizer_register_options_property' ) ) :
	function noo_customizer_register_options_property( $wp_customize ) {
		...
		// Control: Agent Columns
		$helper->add_control(
			'noo_agent_columns',
			'select',
			__( 'Number of Columns', 'noo' ),
			'2',
			array(
				'choices' => array(
					'2'     => __( 'Two', 'noo' ),
		...
		// Control: Agent Grid Style
		$helper->add_control(
			'noo_agent_grid_style',
			'select',
			__( 'Grid Style', 'noo' ),
			'ava-left',
			array(
				'choices' => array(
					'ava-left'     => __( 'Avatar Left', 'noo' ),
					'ava-top'     => __( 'Avatar Top', 'noo' ),
				)
			),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
			'noo_property_display_style',
			'noo_radio',
			__( 'Display Style', 'noo' ),
			'style-1',
			array(
				'choices' => array(
					'style-1'   => __( 'Show Extended Features', 'noo' ),
					'style-2'   => __( 'Show More Detail', 'noo' ),
				)
			),
			array( 'transport' => 'postMessage' )
		);
		...
		//Control: Show/Hide Property Sold
		$helper->add_control(
			'noo_property_listing_sold',
			'noo_switch',
			__('Show Property Sold','noo'),
			1,
			array(),
			array( 'transport' => 'postMessage' )
		);
		...
		// Control: Print
		$helper->add_control(
			'noo_property_print_button',
			'noo_switch',
			__( 'Show Print Button', 'noo' ),
			0,
			array(),
			array( 'transport' => 'postMessage' )
		);
