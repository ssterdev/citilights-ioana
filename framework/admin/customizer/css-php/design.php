...
$noo_site_secondary_color_darken_15       = darken( $noo_site_secondary_color, '15%' );

$noo_site_link_color_lighten_10           = lighten( $noo_site_link_color, '10%' );
$noo_site_link_color_lighten_60           = lighten( $noo_site_link_color, '60%' );
...
.bg-primary-overlay {
	background: <?php echo fade($noo_site_link_color, '90%'); ?>;	
}
...
.chosen-container .chosen-results li.highlighted {
  background: <?php echo $noo_site_link_color; ?> !important;
}
...
<?php if( noo_citilights_is_active_IDX() ) : ?>
/* IDX Optima Express*/
#ihf-main-container .btn-primary:hover, #ihf-main-container .btn:hover,
#ihf-main-container .btn {
    background: <?php echo esc_attr( $noo_site_link_color ); ?>;
    border-color: <?php echo esc_attr( $noo_site_link_color ); ?>;
}

#ihf-main-container .btn-primary:hover, #ihf-main-container .btn:hover,
#ihf-main-container .ihf-map-icon,
#ihf-main-container .ihf-map-icon:hover {
    background: <?php echo esc_attr( $noo_site_link_color_darken_15 ); ?>;
    border-color: <?php echo esc_attr( $noo_site_link_color_darken_15 ); ?>;
}

#ihf-main-container .btn-primary,
#ihf-main-container .ihf-map-icon {
	background: <?php echo esc_attr( $noo_site_secondary_color ); ?>;
    border-color: <?php echo esc_attr( $noo_site_secondary_color ); ?>;
}

#ihf-main-container .nav-tabs > li.active > a,
#ihf-main-container a,
#ihf-main-container .listing-info-item:hover:before,
#ihf-main-container a:hover,
#ihf-main-container a:focus,
#ihf-main-container .ihf-grid-result-container a {
	color: <?php echo esc_attr( $noo_site_link_color ); ?>;
}

#ihf-main-container .nav > li > a:hover, #ihf-main-container .nav > li > a:focus,
...
#ihf-main-container .form-control:focus {
    border-color: <?php echo esc_attr( $noo_site_link_color ); ?>;
    outline: 0;
    -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px <?php echo esc_attr( $noo_site_link_color_lighten_60 ); ?>;
    box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px <?php echo esc_attr( $noo_site_link_color_lighten_60 ); ?>;
}

#ihf-main-container .ihf-map-icon:after {
    border-top-color: <?php echo esc_attr( $noo_site_secondary_color ); ?>;
}
#ihf-main-container .ihf-map-icon:hover:after {
    border-top-color: <?php echo esc_attr( $noo_site_link_color_darken_15 ); ?>;
}
#ihf-main-container .ihf-grid-result-container a:hover,
#ihf-main-container #ihf-map-canvas .ihf-map-info-box-title a:hover,
#ihf-main-container #ihf-map-canvas .leaflet-bottom a:hover,
#ihf-main-container #ihf-map-canvas .leaflet-popup-close-button:hover {
	color: <?php echo esc_attr( $noo_site_secondary_color ); ?>
}
...
{
    background-color: <?php echo $noo_site_secondary_bg; ?> !important;
}