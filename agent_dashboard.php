			...
			<div class="<?php noo_main_class(); ?>" role="main">
				<div class="properties list my-properties">
					...
					if( !empty( $agent_id ) ) {
						...
						$args = apply_filters('noo_agent_dasboard_property_query', $args);
					...
					?>
					<?php if ( !empty( $agent_id ) && $wp_query->have_posts() ) : ?>
						...
						<?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
							...
							if( $membership_type == 'submission' ) {
								$paid_listing		= (bool) get_post_meta( $post_ID, '_paid_listing', true );
							...
							// ==== Check link status
								if ( $post_status == 'pending' && current_user_can( 'edit_posts' ) ) :
						...
						<article id="property-<?php the_ID(); ?>" <?php post_class(); ?>>
							<div class="property-featured">
								...
								?>
								<a class="content-thumb" href="<?php echo $permalink; ?>">
									<?php
									  if ($img != null) {
					                    echo $img;
					                } if ($img == null) {
								...
								?>
								<?php 
								$_label = get_post_meta(null,'_label',true);
							...
							<div class="property-wrap">
								<h2 class="property-title">
									<a href="<?php echo $permalink; ?>" title="<?php echo esc_attr( sprintf( __( 'Permanent link to: "%s"','noo' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a>
								</h2>
								...
								<div class="property-summary">
									<?php echo re_property_summary( array( 'property_id' => $post_ID ) ); ?>
									<div class="property-info">
										<div class="property-price">
											<span><?php echo re_get_property_price_html($post_ID)?></span>
										</div>
